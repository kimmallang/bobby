...
public class FreeBoardServiceTest {
	...
	@Test
	public void getList() {
		assertEquals(20, freeBoardService.get(0, 20, null).getItems().size());
	}
	...
	public void insert() {
		...
		final FreeBoardDto savedFreeBoardDto = (FreeBoardDto)freeBoardService.get(0, 1, null).getItems().get(0);
